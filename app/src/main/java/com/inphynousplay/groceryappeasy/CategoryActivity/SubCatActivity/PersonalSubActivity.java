...
public class PersonalSubActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if (CategoryName.equals("SkinCare") && CategoryName != null) {

            query = groceryRef.orderByChild("FaceCare").equalTo(CategoryName);
            LoadDataIntoRecycler();

        } else if (CategoryName.equals("Soaps") && CategoryName != null) {
            query = groceryRef.orderByChild("type").equalTo(CategoryName);
            LoadDataIntoRecycler();
        } else if (CategoryName.equals("HairOil") && CategoryName != null) {

            query = groceryRef.orderByChild("type").equalTo(CategoryName);
            LoadDataIntoRecycler();

        } else if (CategoryName.equals("HairColor") && CategoryName != null) {

            query = groceryRef.orderByChild("type").equalTo(CategoryName);
            LoadDataIntoRecycler();

        } else if (CategoryName.equals("Shampoo") && CategoryName != null) {

            query = groceryRef.orderByChild("type").equalTo(CategoryName);
            LoadDataIntoRecycler();

        } else if (CategoryName.equals("HairConditioner") && CategoryName != null) {

            query = groceryRef.orderByChild("type").equalTo(CategoryName);
            LoadDataIntoRecycler();

        } else if (CategoryName.equals("Toothpaste") && CategoryName != null) {

            query = groceryRef.orderByChild("type").equalTo(CategoryName);
            LoadDataIntoRecycler();

        } else if (CategoryName.equals("SanitoryNapkins") && CategoryName != null) {

            query = groceryRef.orderByChild("type").equalTo(CategoryName);
            LoadDataIntoRecycler();

        }else if (CategoryName.equals("Deos") && CategoryName != null) {

            query = groceryRef.orderByChild("type").equalTo(CategoryName);
            LoadDataIntoRecycler();

        }else if (CategoryName.equals("ShavingCream") && CategoryName != null) {

            query = groceryRef.orderByChild("type").equalTo(CategoryName);
            LoadDataIntoRecycler();

        }else if (CategoryName.equals("MenRazor") && CategoryName != null) {

            query = groceryRef.orderByChild("type").equalTo(CategoryName);
            LoadDataIntoRecycler();

        }else if (CategoryName.equals("WomenRazor") && CategoryName != null) {
                    ...
                    protected void onBindViewHolder(@NonNull PackagedProductViewHolder holder, int position, @NonNull GroceryProducts model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (model.getStatus().equals("true")) {
                                    Intent intent = new Intent(PersonalSubActivity.this, ProductDetailActivity.class);
                                    intent.putExtra("pid", model.getPid());
                                    startActivity(intent);

                                } else {
                                    Toast.makeText(PersonalSubActivity.this, "Product is out of stock", Toast.LENGTH_SHORT).show();
                                }
